        ...
        <main>
            <div className="main">
                ...
                <div className="main__inner2">
                    ...
                    <button className='katalog'>Перейти в каталог</button>
                    <button className='dicrement'><img src={Vector1} alt="" /></button>
                    <button className='icrement'><img src={Vector1} alt="" /></button>
                </div>

                <div className="main__inner3">
                    <h2>СКИДКИ</h2>
                    <div className="main__list3">
                        <div>
                            <img src={Sariq1} alt="" />
